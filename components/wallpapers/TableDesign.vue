...
const tableBlur = computed(() => props.wallpaperOptions.tableBlur ?? 20);
const tableBlurOpacity = computed(() => props.wallpaperOptions.tableBlurOpacity ?? -0.2);
const titleFontScale = computed(() => props.wallpaperOptions.titleFontSize || 1.0);
const titleFontWeight = computed(() => props.wallpaperOptions.titleFontWeight || 600);
const titleDropShadow = computed(() => props.wallpaperOptions.titleDropShadow ?? true);
